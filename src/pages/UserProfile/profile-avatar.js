        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <p style={{textDecoration: 'underline'}}><a href="/users/edit/14697063">Click here to
                  edit</a></p>
            </div>
            <div className="col-md-4">
              <ul className="icon-detail">
                <li> <i className="fas fa-history" /> Member for 9 days 
                </li><li> <i className="fas fa-eye"> </i> 0 profile views</li>
